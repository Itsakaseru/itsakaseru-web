    ...
    const links = [
        {
            icon: faWindows,
            name: "Windows 64-bit",
            link: "https://dl.itsakaseru.me/onKeys-Win-v1.0.1.zip"
        },
        {
            icon: faApple,
            name: "Apple (Universal)",
            link: "https://dl.itsakaseru.me/onKeys-Mac-v1.0.1.zip"
        },
        {
            icon: faUbuntu,
            name: "Linux 64-bit (Untested)",
            link: "https://dl.itsakaseru.me/onKeys-Linux-v1.0.1.zip"
        }
    ]
        ...
        <>
            ...
            <div className="w-full my-16 flex justify-center">
                <div className="flex flex-col max-w-xs gap-6 my-auto bg-white p-10 rounded-lg shadow-normal">
                    ...
                    <div className="flex flex-col gap-3">
                        <p className="text-center text-sm text-gray-400">v1.0.1</p>
