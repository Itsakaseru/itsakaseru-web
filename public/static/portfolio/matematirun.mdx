...
<Gallery
    items={[
        {
            src: "/static/portfolio/matematirun/splash-screen.png",
            alt: "MateMatirun splash screen",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/main-menu.png",
            alt: "MateMatirun main menu",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/song-select.png",
            alt: "MateMatirun song selection screen",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/difficulty-select.png",
            alt: "MateMatirun difficulty selection screen",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/gameplay.png",
            alt: "MateMatirun gameplay",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/score.png",
            alt: "MateMatirun final score screen",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/settings.png",
            alt: "MateMatirun settings screen",
            type: "image"
        },
        {
            src: "/static/portfolio/matematirun/credits.png",
