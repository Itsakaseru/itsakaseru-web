...
logo: /static/portfolio/security-slip/logo.png
color: orange
year: 2021
...
<Gallery
    images={[
        { src: "/static/portfolio/security-slip/main-menu.png", alt: "Security SLip main menu" },
        { src: "/static/portfolio/security-slip/gameplay.png", alt: "Security SLip gameplay" },
        { src: "/static/portfolio/security-slip/computer-ui.png", alt: "Security SLip computer user interface" },
        { src: "/static/portfolio/security-slip/upgrade-ui.png", alt: "Security SLip upgrade user interface" },
        { src: "/static/portfolio/security-slip/db-searching.png", alt: "Security SLip database searching user interface" },
    ]}
