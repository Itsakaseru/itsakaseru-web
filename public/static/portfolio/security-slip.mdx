...
<Gallery
    items={[
        {
            src: "/static/portfolio/security-slip/main-menu.png",
            alt: "Security SLip main menu",
            type: "image"
        },
        {
            src: "/static/portfolio/security-slip/gameplay.png",
            alt: "Security SLip gameplay",
            type: "image"
        },
        {
            src: "/static/portfolio/security-slip/computer-ui.png",
            alt: "Security SLip computer user interface",
            type: "image"
        },
        {
            src: "/static/portfolio/security-slip/upgrade-ui.png",
            alt: "Security SLip upgrade user interface",
            type: "image"
        },
        {
            src: "/static/portfolio/security-slip/db-searching.png",
