                    ...
                    <div className="m-0 mt-8 sm:m-24 flex flex-row flex-wrap justify-evenly gap-8">
                        {
                            ...
                            {
                                return (
                                    <Link key={ index } href={ `portfolio/${ id }`} id={ name } className="flex flex-col sm:flex-row justify-evenly sm:justify-start p-6 sm:p-0 space-y-6 sm:space-y-0 max-w-none sm:max-w-md w-full sm:w-auto items-center rounded-lg shadow-normal bg-white transform transition duration-500 hover:scale-110">
